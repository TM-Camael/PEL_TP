...
// Le coin superieur gauche est en (x,y)
void dessine_rectangle(int x,int y,int l,int h);

// Dessine le cercle de centre (x,y) et de rayon r
void dessine_cercle(int x,int y,int r);
...
// Le coin inferieur gauche est en (x,y)
